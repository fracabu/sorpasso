  ...
  <div class="bg-black text-white overflow-x-hidden">
    ...
    <section class="relative h-screen overflow-hidden">
      <div
        ...
        :style="{ backgroundImage: `url('/images/Tours%20Auto/PHOTO-2025-09-19-20-38-43.jpg')` }"
      >
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-12" data-aos="fade-up">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">{{ t('tour.auto.gridTitle') }}</h2>
          <p class="text-white/70 max-w-3xl mx-auto">
            {{ t('tour.auto.gridDescription') }}
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          >
            <div
              ...
              :style="{ backgroundImage: `url('/images/Tours%20Auto/${tour.photo}')` }"
            >
    ...
    <!-- CTA Section -->
    <section class="py-20 px-4 sm:px-6 lg:px-8 bg-zinc-900/50">
      <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
        <h2 class="text-3xl md:text-4xl font-bold mb-6">{{ t('tour.auto.ctaTitle') }}</h2>
        <p class="text-white/70 mb-8 text-lg">
          {{ t('tour.auto.ctaDescription') }}
        </p>
        <router-link
          to="/contatti"
          class="btn-primary inline-block"
        >
          {{ t('tour.auto.ctaButton') }}
        </router-link>
      </div>
    </section>
  </div>
